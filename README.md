# Hello! I'm John Asaro :)

🎓 **Computer Science & Psychology Student at Connecticut College**  
...
- Presented findings at the SSRI Poster Symposium and am drafting a paper for academic publication.  
...
🔗 [Learn more on my LinkedIn](https://www.linkedin.com/in/johnmasaro/)  

#### 🎮 **AI-Driven Gameplay in VizDoom**  
- Designing and implementing an **evolutionary computation framework** to optimize bot performance in a highly dynamic FPS environment.
- Created a **custom VizDoom-Gym environment** to train agents using reinforcement learning and genetic algorithms.  
...
### 🌐 Featured Projects
- 🕹️ **[VizDoom Bot](https://github.com/JohnAsaro/vizdoom-bot)**  
  _Evolutionary computation to train AI for DOOM gameplay._
- 🎮 **[Reaper](https://github.com/JohnAsaro/reaper-game)**  
  _Unity-based game featuring advanced obstacle detection and collaborative design._  
- 🤖 **[Line-Following Robot](https://github.com/JohnAsaro/line-follower)**  
  _Arduino-powered robot integrating hardware with software._  
...
### 🎯 Let's Collaborate!
I'm always open to collaboration on projects involving AI, computational theory, or game development. Feel free to reach out!  
📫 [Email me](mailto:jasaro@conncoll.edu) | [LinkedIn](https://linkedin.com/in/johnmasaro)
